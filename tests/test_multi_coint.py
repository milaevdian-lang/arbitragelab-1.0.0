...
class TestMultivariateCointegration(unittest.TestCase):
    ...
    def test_calc_log_price_result(self):
        ...
        result_test_sample = log_price.iloc[-1]

        self.assertAlmostEqual(result_test_sample['AEX'], 6.179954539922313)
        self.assertAlmostEqual(result_test_sample['DAX'], 8.466975108255552)
        self.assertAlmostEqual(result_test_sample['FTSE'], 8.5581662145311)
        self.assertAlmostEqual(result_test_sample['CAC'], 8.408569579869317)
    ...
    def test_calc_price_diff_result(self):
        ...
        # Test the last value
        price_diff_tail = price_diff.iloc[-1]

        self.assertAlmostEqual(price_diff_tail['AEX'], 14.8200, 3)
        self.assertAlmostEqual(price_diff_tail['DAX'], 171.7999, 3)
        self.assertAlmostEqual(price_diff_tail['FTSE'], 79.5799, 3)
        self.assertAlmostEqual(price_diff_tail['CAC'], 115.9400, 3)
